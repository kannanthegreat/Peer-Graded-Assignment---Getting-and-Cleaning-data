...
# Assumes the Git repository : https://github.com/kannanthegreat/Peer-Graded-Assignment---Getting-and-Cleaning-data
...
setwd(dir="C:/Users/kannanthegreat/Documents/GitHub/Peer-Graded-Assignment---Getting-and-Cleaning-data")
path <- getwd()
